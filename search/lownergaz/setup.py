...
def create_lownergaz_faiss_document_store(name: str = "lownergaz"):
...
def add_lownergaz_search_components(search: Pipeline,
    ...
    if search_algorithm == "bm25":
        ...
        add_lownergaz_gazetteers(document_store, items)
        ...
        if not os.path.exists(faiss_index_path) or reset:
            ...
            ann_retriever = EmbeddingRetriever(
                ...
                top_k=search_topk)
            add_lownergaz_gazetteers(document_store, items)  # type: ignore
