...
def init_query_filter_db(instances: List, search, chunk_size: int,
                         filter_exact_match: bool, search_kwargs: dict):
...
def run_database_query_with_filter(chunk_idx: int):
    ...
    for item in chunk:
        ...
        result = search_pipeline.run(query=sentence,
                                     params=params)  # type: Pipeline
